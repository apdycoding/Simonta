...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/staff/Mastersurah/new" class="btn btn-primary"> <i class="fa fa-user-plus" aria-hidden="true"></i> <span>Add Hafalan</span>
            </a>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="alert alert-info alert-dismissible show fade">
                    <div class="alert-body">
                        ...
                        <code><b>Show data</b></code> dan <code>cetak sertifikat satu persatu</code>
                        <br>
                ...
                <div class="card">
                    <div class="card-header" class="float-right">
                        ...
                        <div class="card-header-action">
                            <a href="/staff/Mastersurah" class="btn btn-info"> <i class="fas fa-spinner"> Refresh</i>
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="/staff/Mastersurah/<?= $s['santri_id']; ?>" class="btn btn-warning btn-sm"> <i class="fas fa-info-circle"></i> Lihat detail hafalan anak</a>
