...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="/staff/Cetakhadits" class="btn btn-primary btn-sm"> <i class="fas fa-arrow-left"></i></a>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/staff/Cetakhadits" method="post" autocomplete="off" enctype="multipart/form-data">
                            <?= csrf_field() ?>
