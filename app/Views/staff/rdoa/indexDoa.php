                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form action="/staff/Lapdoa/" method="post" class="d-inline">
                                <?= csrf_field(); ?>
                            ...
                            <a href="/staff/Lapdoa" class="btn btn-info"><i class="fa fa-spinner"> Refresh</i></a>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-md" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $key => $value) {
                                        ...
                                        $data = $this->MdoaModel->dataSama($id);
