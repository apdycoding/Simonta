...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="/staff/Masterdoa/<?= $editData['santri_id'] ?>" class="btn btn-primary btn-sm"> <i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Updated data hafalan</h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/staff/Masterdoa/<?= $editData['mdoa_id'] ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <!-- <select name="santri_id" id="santri_id" class="form-control select2 <?= $validation->hasError('santri_id') ? 'is-invalid' : '' ?>">
                                        ...
                                        <?php foreach ($names as $n) : ?>
                                            <option value="<?= $n['santri_id']; ?>" <?= $editData['santri_id'] == $n['santri_id'] ? 'selected' : '' ?>> <?= $n['name_santri']; ?> </option>
                                        <?php endforeach; ?>
                                    </select> -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="dtgl_ujian" class="form-control <?= $validation->hasError('dtgl_ujian') ? 'is-invalid' : '' ?>" value="<?= $editData['dtgl_ujian'] ?>" id="">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="predikat" class="form-control <?= $validation->hasError('predikat') ? 'is-invalid' : '' ?>" value="<?= $editData['predikat']; ?>" id="">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="penguji_id" class="form-control <?= $validation->hasError('penguji') ? 'is-invalid' : '' ?>" id="">
                                        ...
                                        foreach ($penguji as $key => $value) : ?>
                                            ...
                                            <option value="<?= $value['penguji_id']; ?>" <?= $value['penguji_id'] == $editData['penguji_id'] ? 'selected' : null ?>>- <?= $value['nama_penguji']; ?> -</option>
