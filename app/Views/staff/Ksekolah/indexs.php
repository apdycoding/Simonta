...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/staff/Ksekolah/new" class="btn btn-primary"> <i class="fa fa-user-plus" aria-hidden="true"></i> <span>Add data</span>
            </a>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/staff/Ksekolah" class="btn btn-info"><i class="fa fa-spinner"> Refresh</i></a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="/staff/Ksekolah/edit/<?= $s['kepsek_id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt"></i><span> Edit</span></a>

                                                    <form action="/staff/Ksekolah/delete/<?= $s['kepsek_id']; ?>" method="POST" class="d-inline" id="del-<?= $s['kepsek_id']; ?>">
                                                        <?= csrf_field(); ?>
