                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/staff/Cetaksurah" class="btn btn-info"><i class="fa fa-spinner"> Refresh</i></a>
                        </div>
                    </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            if ($jml >= 1) { ?>
                                                ...
                                                <td rowspan="<?= $jml ?>">
                                                    <a href="/staff/Cetaksurah/<?= $value['santri_id']; ?>" class="btn btn-warning btn-sm" target="_blank"><i class="fas fa-certificate"></i> Cetak serti</a>
                                                </td>
