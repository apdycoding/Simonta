...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/staff/Santristaff/new" class="btn btn-primary"> <i class="fa fa-user-plus" aria-hidden="true"></i> <span>Add Santri</span>
            </a>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header" class="float-right">
                        <h4> Data santri active <code><?= session()->roleUser ?></code></h4>
                        <div class="card-header-action">
                            <a href="/staff/Santristaff" class="btn btn-info"><i class="fas fa-spinner"> Refresh</i>
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <a href="/staff/Santristaff/show/<?= $s['santri_id'] ?>" class="btn btn-info btn-sm"><i class="fa fa-check-square"></i><span> Detail</span></a>
