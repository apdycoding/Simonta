                ...
                <div class="card">
                    <div class="card-header" class="float-right">
                        ...
                        <div class="card-header-action">
                            <a href="/staff/Santristaff" class="btn btn-warning"><i class="fas fa-chevron-left"> Back to santri active</i>
                            </a>
                            <a href="/staff/Santristaff/inactive" class="btn btn-info"><i class="fas fa-spinner"> Refresh</i> </a>
                        </div>
                    </div>
                    <div class="card-body">
