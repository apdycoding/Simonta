...
<title>Hadits Page &mdash; Simon</title>
<?= $this->endSection(); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header" class="float-right">
                        <a href="/staff/Masterhadits/<?= $editData['Mhadits_id']; ?>/edit">
                            <h4> Updated data Hadits</h4>
                        </a>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="/staff/Masterhadits/<?= $editData['Mhadits_id'] ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="htgl_ujian" class="form-control <?= $validation->hasError('htgl_ujian') ? 'is-invalid' : null ?>" value="<?= old('htgl_ujian', $editData['htgl_ujian']) ?>" id="">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="predikat" class="form-control <?= $validation->hasError('predikat') ? 'is-invalid' : null ?>" value="<?= old('predikat', $editData['predikat']) ?>" id="">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="penguji_id" class="form-control <?= $validation->hasError('penguji') ? 'is-invalid' : '' ?>" id="">
                                        ...
                                        foreach ($penguji as $key => $value) : ?>
                                            ...
                                            <option value="<?= $value['penguji_id']; ?>" <?= $editData['penguji_id'] == $value['penguji_id'] ? 'selected' : '' ?>>- <?= $value['nama_penguji']; ?> -</option>
    ...
    function loaddhadits_id() {
        ...
        $("#santri_id").change(function() {
            ...
            $.ajax({
                ...
                url: "<?= base_url() ?>/staff/Masterhadits/getDataSantri",
                data: {
                    [csrfToken]: csrfHash,
