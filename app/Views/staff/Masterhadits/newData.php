...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="/staff/Masterhadits" class="btn btn-primary btn-sm"> <i class="fas fa-arrow-left"></i></a>
        </div>
                ...
                <div class="card">
                    <div class="card-header" class="float-right">
                        <a href="/admin/Datahadits/new">
                            <h4> Input data <code> <?= session()->roleUser ?></code></h4>
                        </a>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="/staff/Masterhadits" method="post" autocomplete="off" enctype="multipart/form-data">
