            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/kepsek/HeadSchool/update/<?= $edit['kepsek_id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a href="/kepsek/HeadSchool" class="btn btn-warning btn-sm"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to</a>
                            </div>
                        </form>
