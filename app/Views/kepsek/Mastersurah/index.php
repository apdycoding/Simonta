                ...
                <div class="card">
                    <div class="card-header" class="float-right">
                        ...
                        <div class="card-header-action">
                            <a href="/kepsek/Mastersurah" class="btn btn-info"> <i class="fas fa-spinner"> Refresh</i>
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="/kepsek/Mastersurah/<?= $s['santri_id']; ?>" class="btn btn-warning btn-sm"> <i class="fas fa-info-circle"></i> Lihat detail hafalan anak</a>
