...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= site_url('santri') ?>" class="btn btn-primary btn-sm"> <i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Update Santri</h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/santri/update/<?= $santri['santri_id']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
