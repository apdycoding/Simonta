            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/teacher/update/<?= $idteacher['teacher_id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a href="/teacher/edit/<?= $idteacher['teacher_id']; ?>" class="btn btn-info btn-sm"> <i class="fas fa-spinner" aria-hidden="true"></i> Reload</a>
                                <a href="/teacher" class="btn btn-warning btn-sm"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to</a>
                            </div>
                        </form>
