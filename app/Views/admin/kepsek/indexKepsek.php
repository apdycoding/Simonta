...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="/kepsek/new" class="btn btn-primary"> <i class="fa fa-user-plus" aria-hidden="true"></i> <span>Add data</span>
            </a>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/kepsek" class="btn btn-info"><i class="fa fa-spinner"> Refresh</i></a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="/kepsek/edit/<?= $s['kepsek_id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt"></i><span> Edit</span></a>

                                                    <form action="/kepsek/delete/<?= $s['kepsek_id']; ?>" method="POST" class="d-inline" id="del-<?= $s['kepsek_id']; ?>">
                                                        <?= csrf_field(); ?>
