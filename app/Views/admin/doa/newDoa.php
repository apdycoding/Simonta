...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="/doa" class="btn btn-primary btn-sm"> <i class="fas fa-arrow-left"></i></a>
        </div>
                    ...
                    <div class="card-body">
                        <div class="alert alert-info alert-dismissible show fade">
                            <div class="alert-body">
                                ...
                                Silahkan inputkan data <code> hafalan doa Santri</code> yang sudah lulus ujian</code>
                            </div>
                        </div>

                        <form action="/doa/create" method="post" autocomplete="off" enctype="multipart/form-data">
                            <?= csrf_field() ?>
