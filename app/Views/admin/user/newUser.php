                        ...
                        <form action="/users/create" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nameUser" value="<?= old('nameUser') ?>" placeholder="nama users" autofocus class="form-control <?= $validation->hasError('nameUser') ? 'is-invalid' : '' ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" placeholder="Email user" value="<?= old('emailUser') ?>" name="emailUser" class="form-control <?= $validation->hasError('emailUser') ? 'is-invalid' : '' ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="phoneUser" value="<?= old('phoneUser') ?>" placeholder="nama users" autofocus class="form-control <?= $validation->hasError('phoneUser') ? 'is-invalid' : '' ?>">
                                    <div class="invalid-feedback">
