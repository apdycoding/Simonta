            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header" class="float-right">
                        <a href="/admin/Datahadits/edit/<?= $editData['Mhadits_id']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/admin/Datahadits/update/<?= $editData['Mhadits_id'] ?>" method="post" autocomplete="off" enctype="multipart/form-data">
