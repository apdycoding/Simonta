                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/Reportsurah" class="btn btn-info"><i class="fa fa-spinner"> Refresh</i></a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible show fade">
                            <div class="alert-body">
                                ...
                                <code>Cetak dan data</code> yang ditampilkan hanya <code>3 data</code> terakhir <br> untuk melihat seluruh data hafalan santri cek dimenu <code>Hafalan Surah</code>
                            ...
                            <table class="table table-striped table-md" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $key => $value) {
                                        ...
                                        $data = $this->Surahmodel->dataSama($id);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            if ($jml >= 1) { ?>
                                                ...
                                                <td rowspan="<?= $jml ?>">
                                                    <a href="/admin/Reportsurah/show/<?= $value['santri_id']; ?>" class="btn btn-warning btn-sm" target="_blank"><i class="fas fa-certificate"></i> Cetak serti</a>
                                                </td>
