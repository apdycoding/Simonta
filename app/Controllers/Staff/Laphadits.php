...
class Laphadits extends ResourceController
{
    ...
    public function index()
    {
        ...
        // dd($data);
        return view('staff/rhadits/indexData', $data);
    }
    /**
    ...
    {
        // dapatkan data laporan hadits
        $hadits = $this->MhaditsModel->getjoinsantri();

        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        $sheet->mergeCells('B2:G2');
        $sheet->setCellValue('B2', 'Laporan Hafalan Hadits Santri');
        ...
        header('Content-Disposition: attachment;filename=Laphadits.xlsx');
