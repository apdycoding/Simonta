...
class Cetakdoa extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('staff/cetakdoa/indexDoa', $data);
    }
    /**
    ...
    public function show($id = null)
    {
        ...
        return view('staff/Cetakdoa/groupDoa', $data);
    }
    ...
    public function new()
    {
        ...
        return view('staff/cetakdoa/newDoa', $data);
    }

    public function serti($id = null)
    {
        $data = [
    ...
    public function create()
    {
        ...
        return redirect()->to('/staff/Cetakdoa')->with('success', 'Data hafalan doa santri ' . '<code>' . $names[0]['name_santri'] . '</code>' . ' berhasil disimpan');
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('staff/Cetakdoa/editDoa', $data);
    }
    ...
    public function update($id = null)
    {
        ...
        return redirect()->to('/staff/Cetakdoa')->with('success', 'Hafalan doa santri ' . '<code>' . $nameSantri[0]['name_santri'] . '</code>' . ' berhasil di update');
    }
    ...
    public function delete($id = null)
    {
        ...
        return redirect()->to('/staff/Cetakdoa')->with('error', 'Data hafalan doa santri ' . '<code>' . $idname[0]['name_santri'] . '</code>' . ' berhasil dihapus');
    }
}
